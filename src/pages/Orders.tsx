...
export function Orders() {
  ...
  return (
    <div className="space-y-6">
      <h2 className="font-[family-name:var(--font-display)] text-2xl font-bold">{copy.ordersTitle}</h2>
      ...
      {loading ? (
        <div className="grid gap-3">
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="h-20 animate-pulse rounded-3xl border border-black/5 bg-surface" />
          ))}
        </div>
      ) : (
        <div className="grid gap-3">
          ...
          {orders.map((o) => (
            <div key={o.id} className="rounded-3xl border border-black/5 bg-surface p-5 shadow-sm">
              <div className="flex items-start justify-between gap-4">
                <div className="min-w-0">
                  <div className="truncate font-[family-name:var(--font-display)] text-xl font-bold">
